...
git_hub_standard_curve_data_only <- read_excel("~/Desktop/r_studio/cmv_standard_curve_data_only.xlsx")
...
ggplot(git_hub_standard_curve_data_only, mapping = aes(x = ct_value, y = cx_ss, colour = plate))+
...
ggplot(git_hub_standard_curve_data_only, mapping = aes(x = ct_value, y = cx_ss))+
